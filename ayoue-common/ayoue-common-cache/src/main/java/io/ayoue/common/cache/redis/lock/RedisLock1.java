package io.ayoue.common.cache.redis.lock;
...
public class RedisLock1 {
    private static Logger logger = LoggerFactory.getLogger(RedisLock1.class);
     ...
     */
    public RedisLock1(StringRedisTemplate redisTemplate, String key, int expireTime, long timeOut) {
        this.key = key;
     ...
     */
    public RedisLock1(StringRedisTemplate redisTemplate, String key, int expireTime) {
        this.key = key;
        this.expireTime = expireTime;
        this.redisTemplate = redisTemplate;
    }
     ...
     * @param key           锁定key
     */
    public RedisLock1(StringRedisTemplate redisTemplate, String key) {
        this.key = key;
        this.redisTemplate = redisTemplate;
    }
